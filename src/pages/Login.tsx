        ...
        return (
                <div className='w-full h-[100vh] overflow-hidden flex flex-row justify-between bg-[#F8FFFB] px-[8vw] py-[10vh] gap-[5vw]'>
                        ...
                        <div className='w-[50%] bg-white rounded-[1.05vw] p-[2vw]'>
                                <p className='my-[1vh] font-extrabold text-[2vw]'>Sign In</p>
                                <p className='text-[1.2vw] font-semibold my-[1vh]'>Sign in into your account</p>
                                <form className='mt-[2vh] text-[1.05vw] '>
                                        ...
                                        <div className='my-[1.3vw]'>
                                                ...
                                                <div className='w-full relative'>
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="26" viewBox="0 0 22 26" fill="none" className='absolute  left-[2%] top-[2vh]  w-[1.5vw] '>
                                ...
                                <div>
                                        ...
                                        <button className="flex flex-row gap-1 items-center justify-center  w-full  px-[2.5vw] py-[2vh] rounded-md border-[2px] border-[rgba(0,0,0,0.4)]">
                                                <img src="/image/google.png" alt="Google" />
                                                <p>Continue with Google </p>
                                        </button>
                                </div>
                                <p className='my-[2vh] text-[1.05vw] text-center'>Don't have an account ,<Link className='font-bold text-[#0094FF]' to={"/signup"}>Sign Up</Link></p>
                        </div>
                </div>
        )
}
